...
//                     <div
//                         // Outer border is kept as requested in the previous step
//                         className="p-4 border border-[#E2E4E9] rounded-lg"
//                     >
...
//                                 {/* Make sure deleteIcon is imported in your file */}
//                                 <img src={deleteIcon.src} alt="Delete" className="w-8 h-8" />
//                             </button>
//                         </div>

//                         {/* Line 1: Pepperoni Pizza */}
//                         {/* REMOVED: border-t border-gray-100 */}
